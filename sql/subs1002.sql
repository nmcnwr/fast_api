WITH SETTING AS
    (
        select
             ...
             , TO_DATE('2021-09-08 11:40:00', 'YYYY-MM-DD HH24:MI:SS') as TIME_STOP
             , '{scenario_id_list}'                                        as SCENARIO_ID
             , '{trpl_id}'                                                 as TRPL_ID
...
SELECT V_INVOICE
     ...
     , COALESCE(X102.SUMM_$, X101.SUMM_$)                                                                              PAY

     , DECODE(X104.CHARGE_VALUE, 0, null, X104.CHARGE_VALUE)                                                           CHARGE
